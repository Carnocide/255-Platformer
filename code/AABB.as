package code {
	...
	/**
	* The AABB class for collision detection
	*/
	public class AABB {
		...
		/**
		* The constructor for the AABB
		* @param halfWidth Half of the width of the collidor
		* @param halfHeight half of the height of the collider
		*/
		...
		/**
		* Sets the halfwidth and halfheight of the collider
		* also recalculates edges
		* @param halfWidth Half of the width of the collidor
		* @param halfHeight half of the height of the collider
		*/
